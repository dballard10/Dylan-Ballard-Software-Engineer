  ...
  skills: [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Async Processing", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/python.svg" },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Bash / Shell Scripting", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/gnubash.svg", colorIcon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bash/bash-original.svg" },
    ...
    },
    {
      ...
      skills: [
        { name: "Agentic development workflows", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/openai.svg" },
        { name: "0-to-1 rapid prototyping with AI agents", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/anthropic.svg" },
        { name: "Prompt engineering & LLM integration", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/openai.svg" },
        { name: "Claude Code, Cursor, Codex, Gemini", icon: "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/anthropic.svg" },
      ],
    },
  ],
